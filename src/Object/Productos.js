...
const Productos = () => {
    ...
    const p1 = new Producto('Pulsera 1',i1, "H", 25, 10 )
    const p2 = new Producto('Pulsera 1',i2, "M", 25, 10 )
    const p3 = new Producto('Pulsera 1',i3, "H", 25, 10 )
    ...
    const p10 = new Producto('Pulsera 1',i10, "H", 25, 10 )
    ...
    const p21 = new Producto('Pulsera 1',i21, "H", 25, 10 )
    ...
    const p26 = new Producto('Pulsera 1',i26, "H", 25, 10 )
    ...
    const p30 = new Producto('Pulsera 1',i30, "H", 25, 10 )
